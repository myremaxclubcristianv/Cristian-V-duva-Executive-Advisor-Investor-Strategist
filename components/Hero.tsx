...
export default function Hero() {
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto my-auto py-6 sm:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-8 space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <Link
                href="/contact"
                className="w-full sm:w-auto px-8 py-4 bg-accent text-background text-xs font-mono font-semibold uppercase tracking-[0.2em] hover:bg-accent/90 transition-quick text-center touch-active min-h-[48px] flex items-center justify-center"
              >
