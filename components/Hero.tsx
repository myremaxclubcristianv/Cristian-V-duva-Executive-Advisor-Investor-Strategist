...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[100svh] w-full flex flex-col justify-between overflow-hidden bg-[#F6F6F3] text-[#111111] pt-24 sm:pt-32 pb-12 border-b border-[#E1E1DD]"
    >
      {/* Top Metadata */}
      ...
      {/* Center Visual Signature & Monograph Composition */}
      <div className="site-container my-auto py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="border-l-2 border-[#B89B72] pl-6 py-1">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center min-h-[54px] px-9 py-4 bg-[#111111] text-[#F6F6F3] font-mono text-xs font-semibold uppercase tracking-[0.2em] hover:bg-[#B89B72] hover:text-[#FFFFFF] transition-colors shadow-md text-center touch-active"
              >
                <span>PRIVATE CONSULTATION →</span>
              </Link>

              <a
                href="#visual-breathing-space"
                className="inline-flex items-center justify-center min-h-[54px] px-8 py-4 border border-[#111111]/20 text-[#111111] font-mono text-xs font-semibold uppercase tracking-[0.2em] hover:border-[#B89B72] hover:text-[#B89B72] transition-colors text-center touch-active"
              >
                <span>EXPLORE ↓</span>
              </a>
            </div>
          ...
          {/* Right Column: Dominant Monograph Image Frame */}
